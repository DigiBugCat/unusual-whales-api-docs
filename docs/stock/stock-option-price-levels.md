...
**Operation ID**: `PublicApi.TickerController.option_price_level`
...
url = "https://api.unusualwhales.com/api/stock/{ticker}/option/stock-price-levels"
headers = {
...
```javascript
const url = "https://api.unusualwhales.com/api/stock/{ticker}/option/stock-price-levels";
const options = {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY'
