...
**Operation ID**: `PublicApi.OptionContractController.expiry_breakdown`
...
url = "https://api.unusualwhales.com/api/stock/{ticker}/expiry-breakdown"
headers = {
...
```javascript
const url = "https://api.unusualwhales.com/api/stock/{ticker}/expiry-breakdown";
const options = {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY'
