...
**Operation ID**: `PublicApi.TickerController.volatility_stats`
...
url = "https://api.unusualwhales.com/api/stock/{ticker}/volatility/stats"
headers = {
...
```javascript
const url = "https://api.unusualwhales.com/api/stock/{ticker}/volatility/stats";
const options = {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY'
