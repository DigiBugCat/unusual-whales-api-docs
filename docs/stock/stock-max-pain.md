...
**Operation ID**: `PublicApi.TickerController.max_pain`
...
url = "https://api.unusualwhales.com/api/stock/{ticker}/max-pain"
headers = {
...
```javascript
const url = "https://api.unusualwhales.com/api/stock/{ticker}/max-pain";
const options = {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY'
