...
**Operation ID**: `PublicApi.TickerController.vol_oi_per_expiry`
...
url = "https://api.unusualwhales.com/api/stock/{ticker}/option/volume-oi-expiry"
headers = {
...
```javascript
const url = "https://api.unusualwhales.com/api/stock/{ticker}/option/volume-oi-expiry";
const options = {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY'
