...
**Operation ID**: `PublicApi.TickerController.last_stock_state`
...
url = "https://api.unusualwhales.com/api/stock/{ticker}/stock-state"
headers = {
...
```javascript
const url = "https://api.unusualwhales.com/api/stock/{ticker}/stock-state";
const options = {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY'
