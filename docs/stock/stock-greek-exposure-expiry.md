...
**Operation ID**: `PublicApi.TickerController.greek_exposure_by_expiry`
...
```bash
curl -X GET "https://api.unusualwhales.com/api/stock/{ticker}/greek-exposure/expiry" \
...
url = "https://api.unusualwhales.com/api/stock/{ticker}/greek-exposure/expiry"
headers = {
...
```javascript
const url = "https://api.unusualwhales.com/api/stock/{ticker}/greek-exposure/expiry";
const options = {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY'
