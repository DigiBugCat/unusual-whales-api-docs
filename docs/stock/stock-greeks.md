...
**Operation ID**: `PublicApi.TickerController.greeks`
...
```bash
curl -X GET "https://api.unusualwhales.com/api/stock/{ticker}/greeks" \
...
url = "https://api.unusualwhales.com/api/stock/{ticker}/greeks"
headers = {
...
```javascript
const url = "https://api.unusualwhales.com/api/stock/{ticker}/greeks";
const options = {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY'
