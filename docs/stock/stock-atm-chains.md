...
**Operation ID**: `PublicApi.TickerController.atm_chains`
...
```bash
curl -X GET "https://api.unusualwhales.com/api/stock/{ticker}/atm-chains" \
...
url = "https://api.unusualwhales.com/api/stock/{ticker}/atm-chains"
headers = {
...
```javascript
const url = "https://api.unusualwhales.com/api/stock/{ticker}/atm-chains";
const options = {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY'
