...
**Operation ID**: `PublicApi.TickerController.interpolated_iv`
...
url = "https://api.unusualwhales.com/api/stock/{ticker}/interpolated-iv"
headers = {
...
```javascript
const url = "https://api.unusualwhales.com/api/stock/{ticker}/interpolated-iv";
const options = {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY'
