...
**Operation ID**: `PublicApi.TickerController.info`
...
url = "https://api.unusualwhales.com/api/stock/{ticker}/info"
headers = {
...
```javascript
const url = "https://api.unusualwhales.com/api/stock/{ticker}/info";
const options = {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY'
