...
**Operation ID**: `PublicApi.TickerController.flow_per_strike`
...
url = "https://api.unusualwhales.com/api/stock/{ticker}/flow-per-strike"
headers = {
...
```javascript
const url = "https://api.unusualwhales.com/api/stock/{ticker}/flow-per-strike";
const options = {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer YOUR_API_KEY'
